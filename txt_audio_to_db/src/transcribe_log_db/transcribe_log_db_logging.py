"""
Module-specific logging helper for transcribe_log_db package.

This module provides a ready-to-use logger for the transcribe_log_db package,
following the universal logging configuration pattern.

Usage:
    from .transcribe_log_db_logging import logger
    logger.info("Starting transcription logging...")
    logger.debug("Detailed debug information")
    
    # Or get a custom logger
    from .transcribe_log_db_logging import get_logger
    custom_logger = get_logger("transcribe_log_db.custom_module")
"""
...
# Module logger name
MODULE_LOGGER_NAME = "transcribe_log_db"
...
def get_logger(logger_name: str = None, **kwargs):
    """
    Get a logger for the transcribe_log_db package or a custom logger.
    ...
    Example:
        >>> from .transcribe_log_db_logging import get_logger
        >>> custom_logger = get_logger("transcribe_log_db.database_manager")
        >>> custom_logger.info("Processing database...")
    """
