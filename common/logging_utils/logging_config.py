...
LOGGING_CONFIG = {
    ...
    "loggers": {
        ...
        # Transcription and database loggers
        "transcribe_log_db": {
            "file_level": "DEBUG",
            "log_filename": "transcribe_log_db.log",
            "console_output": True,
            "file_output": True
        },
        "transcribe_audio": {
        ...
        # Text processing loggers
        "text_finder": {
            "level": "DEBUG",
            "log_filename": "text_finder.log"
        },
        "text_extractor": {
            "level": "DEBUG", 
            "log_filename": "text_extractor.log"
        },
        "text_ingestion": {
            "level": "DEBUG",
            "log_filename": "text_ingestion.log"
        },
        "audio_finder": {
            "level": "DEBUG",
        ...
        "transcription_ingestion": {
            "level": "DEBUG",
            "log_filename": "transcription_ingestion.log"
        },
        "language_detection": {
            "level": "DEBUG",
